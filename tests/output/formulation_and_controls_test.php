        ...
        return [
            'Horizontal, correct and partially correct' => [
                ...
                [
                    ...
                    'sortablelist' => 'sortablelist horizontal numberingnone notactive',
                    'sortableid' => 'id_sortable_0',
                    'answers' => [
                        ['class' => 'sortableitem correct', 'id' => 'ordering_item_' . md5('Modular'), 'answertext' => $success . "Modular"],
                        ['class' => 'sortableitem correct', 'id' => 'ordering_item_' . md5('Object'), 'answertext' => $success . "Object"],
                        ['class' => 'sortableitem correct', 'id' => 'ordering_item_' . md5('Oriented'), 'answertext' => $success . "Oriented"],
                        ['class' => 'sortableitem partial66', 'id' => 'ordering_item_' . md5('Learning'), 'answertext' => $warning . "Learning"],
                        ['class' => 'sortableitem partial66', 'id' => 'ordering_item_' . md5('Dynamic'), 'answertext' => $warning . "Dynamic"],
                        ['class' => 'sortableitem correct', 'id' => 'ordering_item_' . md5('Environment'), 'answertext' => $success . "Environment"],
                    ],
                ],
            ],
            'Vertical, incorrect' => [
                ...
                [
                    ...
                    'value' => 'ordering_item_497031794414a552435f90151ac3b54b,' .
                        ...
                        'ordering_item_5a35edab0f2bf86dfa3901baa8c235dc',
                    'ablockid' => 'id_ablock_0',
                    'sortablelist' => 'sortablelist vertical numberingnone notactive',
                    'sortableid' => 'id_sortable_0',
                    'answers' => [
                        ['class' => 'sortableitem incorrect', 'id' => 'ordering_item_' . md5('Object'), 'answertext' => $error . "Object"],
                        ['class' => 'sortableitem incorrect', 'id' => 'ordering_item_' . md5('Dynamic'), 'answertext' => $error . "Dynamic"],
                        ['class' => 'sortableitem incorrect', 'id' => 'ordering_item_' . md5('Modular'), 'answertext' => $error . "Modular"],
                        ['class' => 'sortableitem incorrect', 'id' => 'ordering_item_' . md5('Learning'), 'answertext' => $error . "Learning"],
                        ['class' => 'sortableitem incorrect', 'id' => 'ordering_item_' . md5('Environment'), 'answertext' => $error . "Environment"],
                        ['class' => 'sortableitem incorrect', 'id' => 'ordering_item_' . md5('Oriented'), 'answertext' => $error . "Oriented"],
                    ],
                ],
            ],
        ];
